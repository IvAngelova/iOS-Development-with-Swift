...
class StaraZagoraVC: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        RequestManager.fetchData(url: RequestManager.urlStaraZagora, completion: {result in
...
extension StaraZagoraVC: UITableViewDataSource, UITableViewDelegate {
